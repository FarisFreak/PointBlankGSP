...
namespace PointBlank.Auth.Network.ReceivePackets
{
	internal class PROTOCOL_BASE_LOGIN_GARENA_REQ : ReceiveBaseLoginPacket
	{
		...
		public PROTOCOL_BASE_LOGIN_GARENA_REQ(LoginClient Client, byte[] buff)
		{
		...
		{
			CLogger.getInstance().extra_info("[Login Garena] " + this._login + " connecting to the server.");
