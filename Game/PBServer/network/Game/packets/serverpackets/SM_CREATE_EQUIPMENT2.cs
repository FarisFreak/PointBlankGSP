...
{
	public class SM_CREATE_EQUIPMENT2 : SendBaseGamePacket
	{
		public int _count;
		...
		public SM_CREATE_EQUIPMENT2(int item, int type, int p_id, string item_name, int count, int equip, Account p)
		{
			this._item = item;
			this._type = type;
			this.p_id = p_id;
